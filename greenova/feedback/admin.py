...
class BugReportAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Technical Information", {"fields": ("error_messages", "trace_report")}),
        (
            "Impact Assessment",
            {"fields": ("frequency", "impact_severity", "user_impact")},
        ),
        ("Additional Information", {"fields": ("workarounds", "additional_comments")}),
        ("Meta Information", {"fields": ("created_by", "created_at", "updated_at")}),
        (
            "Admin Actions",
