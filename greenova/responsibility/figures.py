...
def generate_responsibility_chart(
    responsibility_counts: dict[str, int], fig_width: int = 600, fig_height: int = 300
) -> Figure:
    """
    ...
    try:
        ...
        if labels:
            ...
            ax.barh(y_pos, counts, align="center", color="#65a879")
            ax.set_yticks(y_pos)
        ...
        logger.error(f"Error generating responsibility chart: {e!s}")
...
def get_responsibility_chart(
    ...
    try:
        ...
        responsibility_data = (
            ...
            .annotate(count=Count("obligation_number"))
            .order_by("-count")
        )
